...
<table style="border: hidden">
    <tr style="border: hidden">
        <th style="border: hidden" WIDTH="75%">
            ...
            <!--<script src="../pronosticos/js/jquery-1.7.min.js"></script>-->
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
            <!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAwwV0w2-Ul1b3K4ZQ9NbFQ9JYuLnUH9f4&callback=initMap"> -->
            <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBnnzmm550Bo1McFJZ_MCaQ5IKha6TH8G8&callback=initMap">
            </script>
            ...
            <script type="text/javascript">
              ...
              jQuery(document).ready(function() {
                ...
                jQuery('#show-hide-img').click(function() {
                  ...
                  if (images == "/../pronosticos/iconos/mapa/hide.png" || images ==
                    "../pronosticos/iconos/mapa/hide.png") {
                    jQuery("#show-hide-img").attr('src', "../pronosticos/iconos/mapa/show.png");
                  } else {
                    jQuery("#show-hide-img").attr('src', "../pronosticos/iconos/mapa/hide.png");
                  }
                  // return false;
                });
              });
            ...
            $directorio = '../images/Reporte_calidad_aire/Reporte_horario/tablamapa.csv';  //----------------------------------------------------------------------------------------------------------------archivo origen
            ...
            try {
                ...
                if(filesize($pathFile) > 0){
                    ...
                    if($fp){
                        ...
                        while (($datos = fgetcsv($fp, ",")) == true){
							...
							<tbody>";
                                    ...
                                    /* 							$estCEN = "<table align=center style='width:100%;'>
                                                                 ...
                                                                 <thead>
                                                                 <tr> <th colspan='2' style='background-color:[COLOR];' align='center'>Regular</th></tr>
                                    ...
                                    $estCEN = "<table align=center style='width:100%;'>
								<caption><strong> ESTACI&Oacute;N: $est1 <br>$ias</strong></caption>" . $header;
                                    $estCAP = "<table align=center style='width:100%;'>
								<caption><strong> ESTACI&Oacute;N: $est2 <br>$ias</strong></caption>" . $header;
                                    $estCOR = "<table align=center style='width:100%;'>
								<caption><strong>ESTACI&Oacute;N: $est3 <br>$ias</strong></caption>" . $header;
                                    $estEMA = "<table align=center style='width:100%;'>
								<caption><strong>ESTACI&Oacute;N: $est4 <br>$ias</strong></caption>" . $header;

                                    $estEPG = "<table align=center style='width:100%;'>
                                <caption><strong>ESTACI&Oacute;N: $est5 <br>$ias</strong></caption>" . $header;
                                    $estFEO = "<table align=center style='width:100%;'>
								<caption><strong>ESTACI&Oacute;N: $est6 <br>$ias</strong></caption>" . $header;

                                    $estJOV = "<table align=center style='width:100%;'>
                                <caption><strong>ESTACI&Oacute;N: $est7 <br>$ias</strong></caption>" . $header;

                                    $estSJR = "<table align=center style='width:100%;'>
								<caption><strong>ESTACI&Oacute;N: $est8 <br>$ias</strong></caption>" . $header;
                                }
                                else{
                        ...
                        $cadena = strftime("%A, %B %d, %Y", strtotime(date("Y-m-d")));
                        $horaActual = date("H");
                        ...
                        echo "<p>Fecha &nbsp;&nbsp;&nbsp;&nbsp;".$newdate."&nbsp;&nbsp;&nbsp;&nbsp;".$horaActual.":00 hrs.</br>
                                      " . $FechaAux . "</p>";
            ...
            ?>
            <div id="relativeDiv">
                <div id="cinta-show-hide-legend" name="cinta-show-hide-legend" class="cinta-show-hide-legend">
                    <span class="cinta-show-hide-span ">
                        &nbsp<img class="cinta-show-hide-legend-img" id="show-hide-img" name="show-hide-img" src="../pronosticos/iconos/mapa/hide.png" alt="img">
                        &nbsp&nbsp
                        Querétaro
                    </span>
                </div>
                <div id="main-legend" name="main-legend" class="container-diagnostico-main">
                    <div class="container-diagnostico">
                        <h5> Inventario de fuentes fijas </h5>
                        <input type="checkbox" name="ckbkmlLayerAlmacenes" value="kmlLayerAlmacenes"> Almacenes <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/combustibles.png" alt="Almacenes"><br>
                        <input type="checkbox" name="ckbkmlLayerBanos" value="kmlLayerBanos"> Baños<br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/banios.png" alt="Baños"><br>
                        <input type="checkbox" name="ckbkmlLayerCarp" value="kmlLayerCarp"> Carpinterias<br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/carpinteria.png" alt="Carpinteria"><br>
                        <input type="checkbox" name="ckbkmlLayerTerminal" value="kmlLayerTerminal"> Terminal de
                        autobuses<br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/terminal.png" alt="Carpinteria"><br>
                        <input type="checkbox" name="ckbkmlLayerConst" value="kmlLayerConst"> Constructoras<br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/construction.png" alt="Constructoras"><br>
                        <input type="checkbox" name="ckbkmlLayerCarton" value="kmlLayerCarton"> Deposito de carton <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/deposito_carton.png" alt="Deposito carton"><br>
                        <input type="checkbox" name="ckbkmlLayerGas" value="kmlLayerGas"> Gaseras<br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/Gasera.png" alt="Gasera"><br>
                        <input type="checkbox" name="ckbkmlLayerCopias" value="kmlLayerCopias"> Fotocopiadoras <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/printer.png" alt="Fotocopiadoras"><br>
                        <input type="checkbox" name="ckbkmlLayerGasolina" value="kmlLayerGasolina"> Gasolineras <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/gasolina.png" alt="Gasolinerias"><br>
                        <input type="checkbox" name="ckbkmlLayerHojalateria" value="kmlLayerHojalateria">
                        Hojalater&iacute;as <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/hojalateria.png" alt="Hojalaterias"><br>
                        <input type="checkbox" name="ckbkmlLayerHospital" value="kmlLayerHospital"> Hospitales <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/hospital.png" alt="Hospitales"><br>
                        <input type="checkbox" name="ckbkmlLayerHotel" value="kmlLayerHotel"> Hoteles <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/Hotel.png" alt="Hoteles"><br>
                        <input type="checkbox" name="ckbkmlLayerLab" value="kmlLayerLab"> Laboratorios <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/laboratorio.png" alt="Laboratorios"><br>
                        <input type="checkbox" name="ckbkmlLayerPan" value="kmlLayerPan"> Panaderias <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/pan.png" alt="Panaderias"><br>
                        <input type="checkbox" name="ckbkmlLayerPollo" value="kmlLayerPollo"> Rosticerias <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/pollo.png" alt="Rosticerias"><br>
                        <input type="checkbox" name="ckbkmlLayerTImpresion" value="kmlLayerTImpresion"> Talleres de
                        impresion <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/taller_impresion.png" alt="Taller de impresion"><br>
                        <input type="checkbox" name="ckbkmlLayerTPintar" value="kmlLayerTPintar"> Talleres de pintura
                        <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/hojalateria.png" alt="Taller de pintura"><br>
                        <input type="checkbox" name="ckbkmlLayerTElectrico" value="kmlLayerTElectrico"> Talleres
                        electricos <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/taller_electrico.png" alt="Taller electrico"><br>
                        <input type="checkbox" name="ckbkmlLayerTMecanico" value="kmlLayerTMecanico"> Taller mecanico
                        <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/taller_mecanico.png" alt="Taller mecanico"><br>
                        <input type="checkbox" name="ckbkmlLayerTintoreria" value="kmlLayerTintoreria"> Tintoreria <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/tintoreria.png" alt="Tintoreria"><br>
                        <input type="checkbox" name="ckbkmlLayerTlapaleria" value="kmlLayerTlapaleria"> Tlapalerias<br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/tlapaleria.png" alt="Tlapaleria"><br>
                        <input type="checkbox" name="ckbkmlLayerTortilleria" value="kmlLayerTortilleria"> Tortillerias
                        <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp<img class="imgLeyend" src="../pronosticos/iconos/mapa/tortilleria.png" alt="Tortilleria"><br>
                    </div>
                </div>
                <div id="map"> </div>
                <br>
        ...
        <th style="border: hidden" WIDTH="25%">
            <img src="../images/Logos/logo_indice_qro.jpg" alt="IAS" width="100%" align="top" />
...
<!-- Recomendaciones -->
<h4 style="text-align: center;">&nbsp;Recomendaciones a la población para cada categoría del índice de aire y salud</h4>
<table align=center style='width:100%;'>
    ...
    <tr class='trLegend'>
        <td class='tdLegend'>
            <a href="http://aire.cemcaq.mx/buena-calidad-del-aire-riesgo-bajo/"><strong>BUENA</strong></a>
        </td>
        <td class='tdLegend'>
            <a href="http://aire.cemcaq.mx/recomendaciones/"><strong>ACEPTABLE</strong></a>
        </td>
        <td class='tdLegend'>
            <a href="http://aire.cemcaq.mx/mala-calidad-del-aire-riesgo-alto/"><strong>MALA</strong></a>
        </td>
        <td class='tdLegend'>
            <a href="http://aire.cemcaq.mx/calidad-del-aire-muy-mala-riesgo-muy-alto/"><strong>MUY MALA</strong></a>
        </td>
        <td class='tdLegend'>
            <a
                href="http://aire.cemcaq.mx/extremadamente-mala-calidad-del-aire-riesgo-extremadamente-alto"><strong>EXTREMADAMENTE MALA</strong></a>
        </td>
        <td class='tdLegend'>
...
<p class="text"><b>Notas</b><br />a) Los índices de aire y salud, las categorías del mismo, el&nbsp;<a href="http://aire.cemcaq.mx/wp-content/uploads/2021/04/Bandas_IAS_NOM_172_SEMARNAT_2019.jpg" target="_blank">color asociado a cada
        categoría</a>, el nivel de riesgo y la descripción de riesgo son las establecidas en la Norma Oficial Mexicana
    NOM-172-SEMARNAT-2019 "Lineamientos para la obtención y comunicación del índice de Calidad del Aire y Riesgos a la
    salud", b) El índice de aire y salud tiene propósitos informativos sobre el estado de la calidad del aire, los
    riesgos a la salud y las medidas de protección que deberán difundirse a la población, c)&nbsp;El índice aire y salud
    sólo tiene fines de información para prevenir a la población en una ciudad o localidad en una hora determinada.</p>
<hr />
