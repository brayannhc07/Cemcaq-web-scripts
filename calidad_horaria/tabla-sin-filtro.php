...
<div class="container" >
    ...
    $directorio = '../images/Reporte_calidad_aire/Reporte_horario/tablamapasimple.csv';
    ...
    try {
        ...
        if(filesize($pathFile) > 0)
        {
            ...
            if($fp)
            {
				...
				<div> <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoBOM.png' alt='Estacion' />
				...
				<div>
                                      ...
                                      <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoCAP.png' alt='Estacion' />
				...
				<div>
                                      ...
                                      <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoCOR.png' alt='Estacion' />
				 ...
				 <div>" . $estName. "</div>
                            ...
                            $tblCon .= "\t\t<th class='th15'>
                                  <div>
                                      ...
                                      <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoEMA.png' alt='Estacion' />
				 ...
				 <div>" . $estName. "</div>
                            ...
                            $tblCon .= "\t\t<th class='th15'>
                                  <div>
                                      ...
                                      <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoEPG.png' alt='Estacion' />
				  ...
				  <div>
                                      ...
                                      <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoFEO.png' alt='Estacion' />
				 ...
				 <div>" . $estName. "</div>
                            ...
                            $tblCon .= "\t\t<th class='th15'>
							 <div>
								 ...
								 <input type='image' class='imgEst' src='../pronosticos/iconos/estacion/IconoJOV.png' alt='Estacion' />
          ...
          "  . $cont . "        
                            ...
                            $tblCon .= "\t\t<td style='width:100%; height:100%; background-color:". $col1 . ";'><div class='divChart' ><p class='spanInlineYC'><a class='spanInlineYC' style='text-decoration:none' title='Ver recomendaciones' target='_blank' href=". $url0 .">" . $val1 . "</a></div></td>\n";
...
<?php
$dataFilePath = "../images/Reporte_calidad_aire/Reporte_horario/datos_mapa.csv";

require '../images/Reporte_calidad_aire/Reporte_horario/funcionesGraficar.php';
$data = getDataFromCsv($dataFilePath);

$compoundNames = getDataCompoundNames($data);

$selectedCompound = isset($_GET["compound"]) ?  $_GET["compound"] : $compoundNames[0];

$variables = searchDataVariableNames($data, $selectedCompound);
$dataPoints = getGroupDataPoints($data, $variables);
?>


<div class="container">
    <form method="GET" class="row g-2 my-4 align-items-center">
        <div class="col-12 col-sm-8 col-md-6">
            <div class="form-floating">
                <select class="form-select" id="floatingSelect" name="compound">
                    <?php foreach ($compoundNames as $compound) : ?>
                        <option <?= $compound === $selectedCompound ? 'selected' : ''; ?> value="<?= $compound; ?>"><?= $compound; ?></option>

                    <?php endforeach; ?>
                </select>
                <label for="floatingSelect">Contaminante/compuesto</label>
            </div>
        </div>
        <div class="col-12 col-sm-auto">
            <button class="btn btn-primary w-100" type="submit">Graficar</button>
        </div>
    </form>
</div>
<script>
  window.onload = function() {
    ...
    var chart = new CanvasJS.Chart("chartContainer", {
      ...
      exportEnabled: true,
      title: {
        text: <?php echo '"Histórico de ' . $selectedCompound . ' por hora (últimas ' . count($data) .
                         ' horas)."'; ?>
      },
      axisX: {
        title: "Hora",
      ...
      data: [
          <?php
          foreach ($dataPoints as $groupName => $groupPoints) {
              echo '{
							type: "line",
							name: "' . $groupName . '", 
							xValueType: "dateTime",
							...
							showInLegend: true, 
							dataPoints: ' . json_encode($dataPoints[$groupName]) . ',
